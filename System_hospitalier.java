...
public class System_hospitalier {
    ...
    private String analyserRequete(Requête requête) {
        // prend un objet de liste class "Requete" et analyse la maladie du patient
        return "requête analysée";
    }

    private String comparerDonnes() {
        // Compare les requetes analysées pour voir si il y a un cluster et le retourne si il en existe
